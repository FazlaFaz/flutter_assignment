import 'package:assignment_flutter/signup_screen.dart';
              ...
              children:<Widget>[
                ...
                Padding(
                  ...
                  child: Container(child: Text(
                    " $loginString  ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22),),
                    decoration:BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                ...
                Align(
                  ...
                  child: FlatButton(onPressed: (){},child: Text(forgetText),),
                ),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    FlatButton(onPressed: (){
                      ...
                      child: Text("Create Account",style:TextStyle(color: primaryColor,fontSize: 16.0)),
